---
title: 《智能体设计模式》之工具使用模式：突破能力边界的外部工具集成[译]
date: 2025-10-18
description: 工具使用模式通过函数调用机制让智能体突破训练数据局限，与外部系统交互。本文翻译自《智能体设计模式》第五章，系统讲解工具使用模式的核心理念、六步流程和六大应用场景（外部信息获取、数据库交互、计算分析、通知发送、代码执行、设备控制），并提供基于 LangChain、CrewAI 和 Google ADK 的完整代码示例。
category: ai
tags: Tool Use, Function Calling, AI Agent, Design Patterns, Agentic AI, LangChain, CrewAI, Google ADK, External Integration
cover: https://media.ginonotes.com/images/20251018_agentic_design_patterns_tool_use/chapter05_fig2.jpg
slug: agentic-design-patterns-tool-use-translation
---
...
以下为原书第五章工具使用模式的内容，原文链接：[Chapter 5: Tool Use (Function Calling)](https://docs.google.com/document/u/0/d/1bE4iMljhppqGY1p48gQWtZvk6MfRuJRCiba1yRykGNE/mobilebasic?tab=t.0&_immersive_translate_auto_translate=1#heading=h.br1g9unt9f33)，译者：[@Gino](https://github.com/ginobefun)
...
![智能体使用工具的一些示例](https://media.ginonotes.com/images/20251018_agentic_design_patterns_tool_use/chapter05_fig1.jpg)
...
脚本的主体部分在标准的 `if **name** == "**main**":` 块内，使用 `kickoff()` 方法运行 Crew 实例的任务。在启动 Crew 之前，检查 `OPENAI_API_KEY` 环境变量是否已设置，这是智能体运行所必需的。
...
![工具使用模式](https://media.ginonotes.com/images/20251018_agentic_design_patterns_tool_use/chapter05_fig2.jpg)
...
1. LangChain 文档（工具使用）：[https://python.langchain.com/docs/integrations/tools/](https://python.langchain.com/docs/integrations/tools/)
2. Google 开发者套件（ADK）文档（工具使用）：[https://google.github.io/adk-docs/tools/](https://google.github.io/adk-docs/tools/)
3. OpenAI 函数调用文档：[https://platform.openai.com/docs/guides/function-calling](https://platform.openai.com/docs/guides/function-calling)
4. CrewAI 文档（工具使用）：[https://docs.crewai.com/concepts/tools](https://docs.crewai.com/concepts/tools)
