...
export const PostContent = ({ children }: PostContentProps) => {
    return (
        <div className="article-content prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-gray-900 dark:prose-headings:text-gray-100
            ...
            prose-p:text-base lg:prose-p:text-lg prose-p:leading-7 lg:prose-p:leading-8 prose-p:text-gray-700 dark:prose-p:text-gray-300
            prose-a:text-ink prose-a:no-underline hover:prose-a:text-ink-light
            prose-strong:text-gray-900 dark:prose-strong:text-gray-100
            prose-code:text-ink dark:prose-code:text-ink prose-code:text-sm lg:prose-code:text-base
